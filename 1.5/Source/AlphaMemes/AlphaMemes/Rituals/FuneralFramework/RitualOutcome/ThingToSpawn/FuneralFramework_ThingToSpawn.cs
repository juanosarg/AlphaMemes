...
{   //Using this for thingdef now
    ...
    public class FuneralFramework_ThingToSpawn
    {
        ...
        public virtual void initComps(Thing thing, Corpse corpse, LordJob_Ritual ritual, bool bestOutcome, bool worstOutcome, RitualOutcomePossibility outcome, RitualOutcomeEffectWorker_FuneralFramework worker)
        {
