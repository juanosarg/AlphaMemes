...
namespace AlphaMemes
{
    ...
    public class RitualOutcomeEffectWorker_FuneralFramework: RitualOutcomeEffectWorker_FromQuality
    {
        ...
        public virtual void ApplyOn(Pawn pawn, Corpse corpse, List<Thing> thingsToSpawn, Dictionary<Pawn, int> totalPresence, LordJob_Ritual jobRitual, RitualOutcomePossibility outcome)
        {
        ...
        public virtual void ExtraOutcomeDesc(Pawn pawn, Corpse corpse, Dictionary<Pawn, int> totalPresence, LordJob_Ritual jobRitual, RitualOutcomePossibility outcome, ref string extraOutcomeDesc, ref LookTargets letterLookTargets)
        {
        ...
        public bool OutcomeChanceWorst(LordJob_Ritual jobRitual, RitualOutcomePossibility outcome) //Doing opposite of Vanilla check if best
        {
            using (List<RitualOutcomePossibility>.Enumerator enumerator = jobRitual.Ritual.outcomeEffect.def.outcomeChances.GetEnumerator())
            {
