...
namespace AlphaMemes
{
    public class DeathActionWorker_RedAcidExplosion : DeathActionWorker
    {
        ...
        public override void PawnDied(Corpse corpse, Lord previousLord)
        {
            ...
            GenExplosion.DoExplosion(corpse.Position, corpse.Map, radius, InternalDefOf.AM_AcidSpit, corpse.InnerPawn, 10, -1, InternalDefOf.AM_GooPop, null, null, null, InternalDefOf.AM_Filth_RedSlime, 1f, 1, null, null,255,false, null, 0f, 1);
        }
