    ...
    public class MapComponent_FurnitureTracker : MapComponent
    {
        ...
        public override void MapComponentTick()
        {
            ...
            if ((tickCounter > tickInterval))
            {
                if (map.IsPlayerHome)
                {
                    if ((Current.Game.World.factionManager.OfPlayer.ideos.GetPrecept(InternalDefOf.AM_Art_Desired) != null || Current.Game.World.factionManager.OfPlayer.ideos.GetPrecept(InternalDefOf.AM_ArtQuality_Expected) != null))
                    {
                    ...
                    if ((Current.Game.World.factionManager.OfPlayer.ideos.GetPrecept(InternalDefOf.AM_Reliquaries_Forbidden) != null))
                    {
                    ...
                    if ((Current.Game.World.factionManager.OfPlayer.ideos.GetPrecept(InternalDefOf.AM_DeathrestCaskets_Abhorrent) != null))
                    {
                    ...
                    if ((Current.Game.World.factionManager.OfPlayer.ideos.GetPrecept(InternalDefOf.AM_Megaliths_Desired) != null))
                    {
                    ...
                    if ((Current.Game.World.factionManager.OfPlayer.ideos.GetPrecept(InternalDefOf.AM_Baths_Desired) != null))
                    {
                    ...
                    if ((Current.Game.World.factionManager.OfPlayer.ideos.GetPrecept(InternalDefOf.AM_AnimaScreams_Delightful) != null))
                    {
                        int animatrees = map.listerThings.ThingsOfDef(ThingDefOf.Plant_TreeAnima).Count();
                        StaticCollections.SetAnimaTreesInTheMap(map, animatrees);
                    }


                    if ((Current.Game.World.factionManager.OfPlayer.ideos.GetPrecept(InternalDefOf.AM_Ranching_CattleCentered) != null))
                    {
                    ...
                    if ((Current.Game.World.factionManager.OfPlayer.ideos.GetPrecept(InternalDefOf.AM_Trees_Despised) != null))
                    {
                        int trees = 0;
                        ...
                        {
                            if (plants[i].def.plant?.IsTree == true)
                            {
                                trees++;
                            }
                        }

                        StaticCollections.SetTreesInTheMap(map, trees);
                    }
                }
