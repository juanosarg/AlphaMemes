...
{
    public class RitualOutcomeEffectWorker_DirtmoleConversion : RitualOutcomeEffectWorker_FromQuality
    {

        public RitualOutcomeEffectWorker_DirtmoleConversion()
        {
        }

        public RitualOutcomeEffectWorker_DirtmoleConversion(RitualOutcomeEffectDef def) : base(def)
        {
        }
        ...
        public override void Apply(float progress, Dictionary<Pawn, int> totalPresence, LordJob_Ritual jobRitual)
        {
            ...
            Pawn pawn3 = jobRitual.PawnWithRole("converted");

            pawn3.genes?.SetXenotype(InternalDefOf.Dirtmole);
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                FilthMaker.TryMakeFilth(c, jobRitual.Map, ThingDefOf.Filth_RubbleRock);
