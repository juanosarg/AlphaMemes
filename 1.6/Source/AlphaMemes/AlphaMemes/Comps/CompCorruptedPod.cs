    ...
    public class CompCorruptedPod : CompDryadHolder
    {
        ...
        protected override void Complete()
        {
            ...
            if (compTreeConnection != null)
            {
                ...
                ((Plant)GenSpawn.Spawn(ThingMaker.MakeThing(InternalDefOf.AM_Plant_CorruptedPodGauranlen, null), this.parent.Position, this.parent.Map, WipeMode.Vanish)).Growth = 1f;
            }
        ...
        public override string CompInspectStringExtra()
        {
            ...
            if (this.innerContainer.Count < 3)
            {
                ...
                {
                    text,
                    GenLabel.BestKindLabel(InternalDefOf.AM_Dryad_Corruptor, Gender.Male, true, -1).CapitalizeFirst(),
                    ": ",
