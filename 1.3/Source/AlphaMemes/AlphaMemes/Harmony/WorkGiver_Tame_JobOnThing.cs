...
namespace AlphaMemes
{
    ...
    public static class AlphaMemes_WorkGiver_Tame_JobOnThing_Patch
    {
        [HarmonyPostfix]
        static void DisallowTamingEvent(Pawn pawn, Thing t, ref Job __result)
        {
            ...
            {
                new HistoryEvent(InternalDefOf.AM_TameAnimal, pawn.Named(HistoryEventArgsNames.Doer)).Notify_PawnAboutToDo_Job();
                __result = null;
            }
